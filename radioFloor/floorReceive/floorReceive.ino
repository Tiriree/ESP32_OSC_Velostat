...
void loop() {
  ...
  if (radio.receiveDone()) {
    ...
    if (radio.DATALEN == sizeof(Packet)) {
      ...
      Serial.print(",");
      Serial.print(newPacket.sensor5);
      Serial.print(",");
      Serial.print(newPacket.sensor6);
      Serial.print(",");
      Serial.print(newPacket.sensor7);
      Serial.print(",");
      Serial.print(newPacket.sensor8);
      Serial.print(",");
      Serial.println(newPacket.sensor9);
      delay(100);
      //Serial.print("\n");
    }
    //    else {
